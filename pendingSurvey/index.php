    ...
    ?>
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12 text-end">
                    <button onclick="change_dir()" class="mt-3 mb-3 btn btn-lg btn-success text-light"><i class="fa-solid fa-check"></i> Completed Surveys</button>
                </div>
                <div class="col-12">
                    <!-- 
        ...
        <script>
            ...
            $("#datatable").DataTable({
                ...
                "order":[],
                "ajax":{
                    "url":"../inc/handle_files/fetch_pending_surveys.php",
                    "type":"post",
                },
            ...
            // change header direction to complete page
            function change_dir(){
                var current_location = window.location.href ; 
                new_location = current_location.replace('/pendingSurvey/', '/completedSurvey/');
