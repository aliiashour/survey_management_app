<?php
    ...
    if($stmt->rowCount()){
        while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
            ...
            $sub_arr[] = '
                            <button data-title="review_survey" data-action="review" id="review_button" class="btn btn-info" data-question_id="' . $row['question_id'] .  '"><i class="fa-solid fa-eye"></i></button>
